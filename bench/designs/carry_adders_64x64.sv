...
module carry_adders_64x64 (
  input  logic         clk, rst,
  input  logic [63:0] x_in, y_in,
  output logic [63:0] s_xor,
  output logic         c_xor
);
  logic [64-1:0][63:0] x_pipe, y_pipe;
  logic [63:0] o [64];
  logic [63:0] co [64];
  logic [63:0] s [64], di [64];
  ...
  genvar g, c;
  generate for (g = 0; g < 64; g++) begin : adder
  ...
  always_comb begin
    s_acc = '0; c_acc = 1'b0;
    for (int i = 0; i < 64; i++) begin s_acc ^= o[i]; c_acc ^= co[i][63]; end
  end
